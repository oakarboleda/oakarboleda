              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full rounded border px-[14px] py-3 text-base outline-none"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full resize-none rounded border px-[14px] py-3 text-base outline-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="border-primary bg-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
